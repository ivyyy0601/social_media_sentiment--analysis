...
def get_ai_brief(price_data):
    ...
    prompt = f"You are a financial analyst. Based on the 7-day price data below, write a concise market brief (max 150 words). Identify top gainers, biggest losers, and overall trend. Be direct.\n\n{summary}"
    try:
        resp = requests.post(
            GROQ_URL,
